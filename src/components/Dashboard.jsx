...
const fetchMembers = async () => {
  try {
    ...
    setStats(prev => ({ ...prev, dependents: totalDependents }));
  } catch (error) {
...
useEffect(() => {
  setStats({
    ...
    dependents: stats.dependents // Keep dependents count
  });
}, [members]);
...
return (
  <div className="container" style={{ maxWidth: '100%' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '30px' }}>
      ...
      <StatCard title="مجموع الرعايا" value={stats.dependents || 0} color="#8b5cf6" icon={Users} />
